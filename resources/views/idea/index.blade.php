        ...
        @foreach ($ideas as $idea)
            <div x-data
                @click="
                    ...
                    const ignores = [ "button"
                , "svg" , "path" , "a" ] if (! ignores.includes(target)) {
                ...
                100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97 2.97 0 10-.003 5.94A2.97
